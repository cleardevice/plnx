...
var _functionRateLimit = require("function-rate-limit");

var _functionRateLimit2 = _interopRequireDefault(_functionRateLimit);
...
var limitedRequest = (0, _functionRateLimit2.default)(_config2.default.limits.queryCount, _config2.default.limits.timePeriod, _request2.default);
...
var _loop = function _loop(command) {
  ...
  exports[command] = function (options, cb) {
    ...
    limitedRequest(ropt, function (err, res, data) {
